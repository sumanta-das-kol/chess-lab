...
var PgnCtrl =
{
	...
	SetBoard: function ()
	{
		var
			mainDiv = Append("div", document.body, "id=mainDiv;",
				"width:542px;height:368px;margin:0px;margin-left:4px;border:solid 1px #ccc;overflow: auto;float:left;"),
			pgnDiv = Append("div", mainDiv, "id=pgnDiv;", 
				"position:relative;width:160px;height:360px;margin:0px;margin-left:4px;border:none;overflow: auto;float:right;");
	...
	SetCaptured: function ()
	{
		var div = Append("div", document.body, "id=capturedDiv",
			"margin:0px;margin-left:4px;width:542px;height:70px;border:solid 1px #888;overflow:auto;float:left; display: none;");
		Append("div", div, "id=whitesDiv", "width:542px;height:25px;background:#dedede;overflow:auto; display: none;");
		Append("div", div, "id=blacksDiv", "width:542px;height:25px;background:#dedede;overflow:auto; display: none;");
